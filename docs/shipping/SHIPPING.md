...
1. [FREE-VS-PRO.md](../product/FREE-VS-PRO.md) — free vs paid  
2. [CALENDAR-V1.md](../auth/CALENDAR-V1.md) — no surprise proxy  
3. [PRIVACY.md](../product/PRIVACY.md) + live `privacy.html`  
...
7. Revisit [FREE-VS-PRO.md](../product/FREE-VS-PRO.md) prices  
